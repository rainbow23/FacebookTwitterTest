...
struct  SslStreamBase_t1724304885_0  : public Stream_t_1021953369_0
{
	// System.IO.Stream Mono.Security.Protocol.Tls.SslStreamBase::innerStream
	Stream_t_1021953369_0 * ___innerStream_3;
	// System.IO.MemoryStream Mono.Security.Protocol.Tls.SslStreamBase::inputBuffer
	MemoryStream_t1490625992_0 * ___inputBuffer_4;
	...
	ManualResetEvent_t_2139627160_0 * ___negotiationComplete_13;
	// System.Byte[] Mono.Security.Protocol.Tls.SslStreamBase::recbuf
	ByteU5BU5D_t1569193387_0* ___recbuf_14;
	// System.IO.MemoryStream Mono.Security.Protocol.Tls.SslStreamBase::recordStream
	MemoryStream_t1490625992_0 * ___recordStream_15;
};
struct SslStreamBase_t1724304885_0_StaticFields{
	...
	ManualResetEvent_t_2139627160_0 * ___record_processing_2;
};
