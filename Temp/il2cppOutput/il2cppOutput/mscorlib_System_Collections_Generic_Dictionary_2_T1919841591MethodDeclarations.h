...
extern "C"  Object_t * Transform_1_BeginInvoke_m788143672_0_gshared (Transform_1_t1919841591_0 * __this, Object_t * ___key, Object_t * ___value, AsyncCallback_t_626615168_0 * ___callback, Object_t * ___object, const MethodInfo* method);
#define Transform_1_BeginInvoke_m788143672_0(__this, ___key, ___value, ___callback, ___object, method) ((  Object_t * (*) (Transform_1_t1919841591_0 *, Object_t *, Object_t *, AsyncCallback_t_626615168_0 *, Object_t *, const MethodInfo*))Transform_1_BeginInvoke_m788143672_0_gshared)(__this, ___key, ___value, ___callback, ___object, method)
